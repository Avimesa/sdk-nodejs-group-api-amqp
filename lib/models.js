...
exports.getBase64Str = function(path){
...
exports.cmd1008 = function(devId, path) {
	return {
		"api_maj": API_MAJ,
		"api_min": API_MIN,
		"cmd_id": 1008,
		"req_id": this.getRequestId(),
		"dev_id": devId,
		"file_buf": this.getBase64Str(path)
	};
};

exports.cmd1010 = function(devId, path) {
	return {
		"api_maj": API_MAJ,
		"api_min": API_MIN,
		"cmd_id": 1010,
...
exports.cmd1020 = function(devId, path) {
	return {
		"api_maj": API_MAJ,
		"api_min": API_MIN,
		"cmd_id": 1020,
